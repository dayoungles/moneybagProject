...
public class BagController {
	 ...
	 * 
	 * @param info 머니백 이름 
	 * @param addUserEmail 추가하려고 하는 유저 이메일을 받기로 했음. 그런데 이거 추가하는 방법도 유동적으로 바꿀 예정. 
	 * @param session
	 * @return
	 */
	...
	public String createRound(@PathVariable("bagId") String bagId, @ModelAttribute("round") Round round, Model model, HttpSession session){
		User user = (User) session.getAttribute("user");
